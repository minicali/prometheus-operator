...
require (
	...
	github.com/minicali/prometheus-operator v0.81.0-exported
...
replace (
	github.com/prometheus-operator/prometheus-operator => github.com/minicali/prometheus-operator v0.81.0-exported
)